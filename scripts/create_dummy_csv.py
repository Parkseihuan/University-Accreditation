...
# Define the CSV format (same as Excel but saved as CSV)
data = {
...
df.to_csv("data/4th-cycle/3.1/faculty_numbers_2021_2025.csv", index=False, encoding="utf-8-sig")
print("Created dummy CSV file: data/4th-cycle/3.1/faculty_numbers_2021_2025.csv")
